...
/// <summary>
/// Vlix OPCBrowser only supports OPC DA 2.05 and OPC DA 3.00
/// </summary>
namespace VlixOPC
{
    ...
    public class OPCUABrowserEngine
    {
        ...
        public OPCUABrowserEngine(string SSLCertificateDirectory = null)
        {
            ...
            if (SSLCertificateDirectory == null) _SSLCertificateDirectory = Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\Vlix\\VlixOPC\\Certs";
                    ...
                    if (NodeIdsSplit.Count() > 0)
                    {
                        ...
                        foreach (string NodeId in NodeIdsSplit)
                        {
                            ...
                            if (SuitableSubscription != null)
                            {
                                ...
                                //After successfully added Item to Existing Subscription, read the values of the item
